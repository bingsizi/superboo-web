package com.superboo.base.security.menu.controller;
...
public class MenuController extends AdminController{
	...
	public Object menuList(ServletRequest request){
		...
		return serviceManager.menuService.findByPage(buildEasyUiPage(request), name);
	}
	...
	public Object delete(Long id){
		try{
			...
			serviceManager.menuService.remove(id);
			return getSuccessMsg("删除菜单成功");
		}catch(Exception e){
			e.printStackTrace();
			return getErrorMsg(e.getMessage());
		}
