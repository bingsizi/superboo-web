...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String[] getXunFirstAndLast(Date date) {
        ...
        String yyyyMM = DateUtils.dateStringFormat(date,"yyyyMM");
        ...
        if(xun==1){
            ...
            arr[0] = yyyyMM+"21";
            arr[1] = DateUtils.dateStringFormat(getMonthLastDay(date),"yyyyMMdd");
        }
    ...
    public static String[] getQuarterFirstAndLast(Date date){
        ...
        switch (jd){
            case 1:
                arr[0] = DateUtils.getYear(date)+"0101";
                arr[1] = DateUtils.getYear(date)+"0331";
                break;
            case 2:
                arr[0] = DateUtils.getYear(date)+"0401";
                arr[1] = DateUtils.getYear(date)+"0630";
                break;
            case 3:
                arr[0] = DateUtils.getYear(date)+"0701";
                arr[1] = DateUtils.getYear(date)+"0930";
                break;
            case 4:
                arr[0] = DateUtils.getYear(date)+"1001";
                arr[1] = DateUtils.getYear(date)+"1231";
                break;
        }
